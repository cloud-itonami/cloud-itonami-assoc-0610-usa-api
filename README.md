# cloud-itonami-assoc-0610-usa-api

Industry rule/policy-statement catalog for the **American Petroleum
Institute** (API) — the FIRST entry aligned to **ISIC 0610**
(extraction of crude petroleum), a new industry code for this family.

> **Note:** "API" here is the American Petroleum Institute, NOT a
> software Application Programming Interface — both share the
> initialism; this repo is unambiguously the oil-and-gas trade
> association (ISIC 0610).
...
[api.org](https://www.api.org/)'s own pages: **About API** (states the
exact founding date, March 20, 1919) and **API's 100 Years of
Standards** microsite (states the exact publication date, October 20,
1924, of API's first-ever standard, "Specifications for Steel and Iron
